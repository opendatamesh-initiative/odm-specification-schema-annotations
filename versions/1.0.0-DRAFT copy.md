...
In this example the `address` property value is of type `string` while the `phoneNumber` property value can be of type `string` or `number`.
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-multipleof)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-maximum)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-exclusivemaximum)*

The `maximum` keyword specifies an exclusive upper limit for the property value.
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-minimum)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-exclusiveminimum)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxlength)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-minlength)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-pattern)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxitems)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-minitems)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxcontains)*

The `maxContains` keywords is defined in function of the JSON Schema core keyword [`contains`]([#contains](https://json-schema.org/draft/2020-12/json-schema-core#name-contains)). Because `contains` is a structural element specific of JSON Schema and not used in otehr DSL, the keyword `maxContains` MUST NOT be used to annotate the data model.

<!-- minContains -->
####  <a name="vocab-validation-kw-minContains"></a>minContains
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-mincontains)*

The `minContains` keywords is defined in function of the JSON Schema core keyword [`contains`]([#contains](https://json-schema.org/draft/2020-12/json-schema-core#name-contains)). Because `contains` is a structural element specific of JSON Schema and not used in otehr DSL, the keyword `minContains` MUST NOT be used to annotate the data model.
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-maxproperties)*
...
*This description is provided here for convenience, but it is not normative. The normative description is defined in the original vocabulary and can be found [here](https://json-schema.org/draft/2020-12/json-schema-validation#name-minproperties)*
