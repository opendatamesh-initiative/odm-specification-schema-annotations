...
####  <a name="vocab-meta-data-logical-kw-nullValues"></a>nullValues

The value of this keyword MUST be an `array` whose item type is equal to the type of the property. 

The `nullValues` keyword specifies a list of values for the property that can be considere as null.
 ...
 "type": "object",
  "properties": {
    ...
    "customerName": {
		"type": "string", 
		"nullable": false,
		"nullValues": ["UNKNOWN", "TBD", "NA"]
	}
  },
}
```

####  <a name="vocab-meta-data-logical-kw-nullValues"></a>nullValuePattern

The value of this keyword MUST be a `string`. This string SHOULD be a valid regular expression, according to the ECMA-262 regular expression dialect.

The `nullValuePattern` keyword specifies the regular expression matched by property null values
 ...
 "type": "object",
  "properties": {
    ...
    "customerName": {
		"type": "string", 
		"nullable": false,
		"nullValuePattern": "^\\s*(UNKNOWN|TBD|NA)?\\s*$""
	}
  },
}
```
