...
- [Schema Annotations Specification](#schema-annotations-specification)
	...
	- [Specification](#specification)
		...
		- [The "sasDialects" Keyword](#the-sasdialects-keyword-1)
...
A vocabulary is a collection of keywords, each paired with a clear and precise definition, designed to enrich structural elements within a schema definition by adding metadata. Every vocabulary MUST have a unique URI that serves as its identifier, ensuring global distinctiveness and referenceability. 
...
If "$vocabulary" is absent, an implementation MAY
