...
|value|description|
---|:---:|
|`tabular`|When all element's properties are not of type object|
|`document`|When the element contains properties of type object|

For all other property types admissible avalues are: 
|value|description|
---|:---:|
|`attribute`|A property that describes data, used for grouping or filtering (e.g., "Category," "Region").|
|`measure`|A property that represents a quantifiable value, used for calculations or analysis (e.g., "Sales," "Profit").|
