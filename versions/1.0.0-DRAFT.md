...
- [DPDS Dialect](#dpds-dialect)
	- [Basic Meta-Data Annotations Vacabulary](#vocab-meta-data)
		- [Keywords applicable either to shema or properties](vocab-meta-data-element-kws)
			- [title](vocab-meta-data-element-kw-title)
			- [description](vocab-meta-data-element-kw-title)
			- [deprecated](vocab-meta-data-element-kw-deprecated)
			- [default](vocab-meta-data-element-kw-default)  		 
		- [Keywords applicable only to properties](vocab-meta-data-properties-kws)
			- [writeOnly](vocab-meta-data-element-kw-writeOnly)
			- [readOnly](vocab-meta-data-element-kw-readOnly)  
	- [Basic Meta-Data Annotations Vacabulary](#vocab-meta-data)
   	- [Basic Meta-Data Annotations Vacabulary](#vocab-meta-data)
- [Appendix A: Revision History](#revision-history)

### <a name="vocab-meta-data-element-kws"></a>

####  <a name="vocab-meta-data-k-title"></a>title
...
### <a name="vocab-meta-data-element-kws"></a>Keywords applicable to shema or properties
...
####  <a name="vocab-meta-data-k-writeOnly"></a>writeOnly
todo

####  <a name="vocab-meta-data-k-readOnly"></a>readOnly
todo
