...
A dialect is a collection of vocabularies. The `sasDialect` keyword, placed in the root object of a schema, specifies the vocabularies in use.

The value of this keyword MUST be a `SasDialect Object` that is a JSON Object complint with the following JSON Sshema.
