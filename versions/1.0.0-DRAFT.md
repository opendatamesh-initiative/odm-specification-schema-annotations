...
A **schema** is a machine-readable representation of a data model defined using a specific **Schema Definition Language**. Each schema definition language is based on a specific meta model and specify how to istantiate it to describe a specific data model.

SAS can be used with any Schema Definition Language capable of describing data model with both tabular and/or document structure.

TODO
type of SDLs
type of keywords core/reserved/annotation
